...
namespace Fut
{
    public partial class frmThong_Tin_NCC : Form
    {
        ...
        {
            if (string.IsNullOrEmpty(txtTenNCC.Text.Trim()) || string.IsNullOrEmpty(txtDiaChi.Text.Trim()) || string.IsNullOrEmpty(txtEmail.Text.Trim()) || string.IsNullOrEmpty(txtSDT.Text.Trim()))
            {
        ...
        private void btnSuaNCC_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(CONSTANTS_NHACUNGCAP.MES_UPDATE_ISSELECTED, CONSTANTS_NHACUNGCAP.MES_INFOR, MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
